...
<form  method="POST" action="/admin_add_notice" enctype="multipart/form-data">
            @csrf 
    <div class="row">
        <div class="col-md-2"></div>
        <div class="col-md-3">
                <span style="font-weight: bold;font-size:25px"><a href="/admin_notice"><i class="fa fa-chevron-left" aria-hidden="true"></i></a> Add Notice</span><br><br>
