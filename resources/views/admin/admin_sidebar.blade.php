...
/* The sidebar menu */
  ...
  <a href='/admin_room'><i class="fa fa-cube" aria-hidden="true"></i> Rooms</a>
  <a href='/admin_change_password/{{Auth::user()->id}}'><i class="fa fa-user-md" aria-hidden="true"></i> Profile</a>
