...
<form  method="POST" action="/edit_room" enctype="multipart/form-data">
    ...
    <div class="row">
        ...
        <div class="col-md-3">
        <span style="font-weight: bold;font-size:25px"><a href="/admin_room"><i class="fa fa-chevron-left" aria-hidden="true"></i></a> Update Room</span><br><br>
            ...
            <input style="width:100%;height:40px" type="number" name="initial_deposit" id="initial_deposit" required value="{{$data['initial_deposit']}}">
            <br><br>
        </div>
        <div class="col-md-1"></div>
        <div class="col-md-1">
