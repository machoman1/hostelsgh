            ...
            <div class="card">
                ...
                <div style="font-family: 'Open Sans', sans-serif;" class="container">
                    <div class="row">
                        ...
                        <div class="col-md-6">
                        <span style="font-weight: bold;font-size:25px"><a href="/admin_city"><i class="fa fa-chevron-left" aria-hidden="true"></i></a> Update City</span>
                            <form  method="POST" action="/edit_city" enctype="multipart/form-data">
                                ...
                                <div style="float: right; padding-top:10px;color:white;padding-left:10px"><a href="/admin_city" class="edit btn btn-primary btn-sm"">Back</a></div>
