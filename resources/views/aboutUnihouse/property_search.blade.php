    ...
    <div class="row">
        ...
        <div class="row py-1">
            ...
            <div class="row">
                ...
                <span>{{$prop_search_count}} Propery Available For Your Search</span>
            </div><br>
            ...
            <div class="row fixed-middle-div ">
                <div class="card">
                @if($prop_search_count > 0)
                @foreach($prop_search as $prop)
                <a href='whole_property_search/{{$prop->id}}'><div class="row">
                    <div  class="col-md-6">
                        <img style="height:70%" src="{{ url('public/images/'.$prop->image)}}" alt="image" loading="lazy"/>
                    </div>
                    <div style="padding-left:px;font-size:12px" class="col-md-6">
                        <span></span><span style="font-weight: bold;">{{$prop->address}}  ({{$prop->city}})</span><br>
                        <span>{{$prop->number_of_rooms}} bed room(s)  <span style="font-weight: bold;"> ({{$prop->property_type}})</span> </span><br>
                        <span style="font-weight: bold;">GHC {{$prop->amount_per_month}}</span> per month</span><br>
                        <span style="font-weight: bold;">Deposit: </span><span>{{$prop->initial_deposit}}</span><br>
                        <span><span style="font-weight: bold;">Rent Type: </span> {{$prop->is_sheard}}</span><br><br>
                    </div>
                </div></a>  
                @endforeach
                @else
                <span style="font-size:30px;font-weight:bold;padding-top:10px">0 Rooms Available</span>
        ...
        <div class="col-md-9 fixed-left-div">
            ...
            <div class="card1">
                <div class="row">
                    ...
                    <div class="col-md-3">
                    <script>
                        document.write('<a style="text-align:center;width:100%" class="btn_top" href="' + document.referrer + '"><i class="fa fa-search"></i>Clear My Search</a>');
                     </script>
                        <!-- <button style="width:100%" href="#" class="btn_top"><i class="fa fa-search"></i> Clear My Search</button> -->
                    </div>
                    <div class="col-md-2"></div>
                </div>
            </div>
