...
<div style="font-family: 'Open Sans', sans-serif;" class="container">
    ...
    <div style="font-family: 'Open Sans', sans-serif;" class="row">
        <div class="col-md-2"></div>
            ...
            <input type="hidden" name="id" value="{{$data_modal['id']}}"> <br>
            <div style="text-align:center"><span style="font-size:25px;">{{$data_modal->title}}</span></div>
            <span>{{$data_modal->content}}</span>
            </div>
