...
<div class="container">
    ...
    <div class="row">
        ...
        <div class="col-md-3">
        <span style="font-weight: bold;font-size:25px"><a href="/landlord_property"><i class="fa fa-chevron-left" aria-hidden="true"></i></a> View Property</span><br><br>
        ...
        <label>Property Location</label><br>
            <select style="width: 100%;" id="property_name" name="property_name">
            <option value="">{{$data['specific_location']}}</option>
            </select>
            <br><br>
            ...
            <br><br>
            <div style="float: right; padding-top:10px;color:white;"><a href="/landlord_property" class="edit btn btn-primary btn-sm"">Back</a></div>
        </div>
