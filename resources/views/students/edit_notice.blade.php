...
<form  method="POST" action="/edit_notice" enctype="multipart/form-data">
    ...
    <div class="row">
        ...
        <div class="col-md-3">
                <span style="font-weight: bold;font-size:25px"><a href="/students_notice"><i class="fa fa-chevron-left" aria-hidden="true"></i></a> Update Notice</span><br><br>
