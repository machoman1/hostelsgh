...
<div class="container">
    ...
    <a  href="/repair"  class="edit btn btn-primary btn-sm" style="font-weight:bold; color:white;"></i> Request A Repair</a><br><br>
        <thead>
            <tr>
                <th>Property Address</th> 
                <th>Detaild of Repair</th>
...
<script type="text/javascript">
  $(function () {
    var table = $('.data-table').DataTable({
        ...
        serverSide: true,
        ajax: {
          url: "{{ route('cust.students_repair') }}",
          data: function (d) {
