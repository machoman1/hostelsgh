                    ...
                    <div class="row">
                        ...
                        <div style="padding-top: 40px;" class="col-md-8">
                            ...
                            <form method="POST" action="{{ route('login') }}">
                                @csrf
                                <input style="width:100%;" type="email" placeholder="Email" name="email" id="email" required autocomplete="off">
                                <div style="padding-top:20px"></div>
                                <input style="width:100%;"  type="password" placeholder="Password" name="password" id="password" required>
                                <div style="float: right; padding-top:10px"><button class="btn_top">Log on</button></div>
